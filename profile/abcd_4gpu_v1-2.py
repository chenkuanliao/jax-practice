...
def run_benchmark(
    ...
    dtype=jnp.float32,
    warmup_rounds=5,
    output_json="abcd_4gpu_v1-2_stats.json",
    trace_dir="abcd_4gpu_v1-2_trace",
):
    ...
    b_pspec = P("island", None)
    c_pspec = P("island", None)
    d_pspec = P("island", None)
    ...
    def expr_abcd(a, b, c, d):
        x = jnp.linalg.multi_dot((a, b, c, d))
...
def main():
    ...
    parser.add_argument("--json", type=str, default="abcd_4gpu_v1-2_stats.json")
    parser.add_argument("--trace-dir", type=str, default="abcd_4gpu_v1-2_trace")
