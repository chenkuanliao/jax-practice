...
def run_benchmark(
    ...
    dtype=jnp.float16,
    warmup_rounds=5,
    output_json="abcdefgh_4gpu_v2-4_stats.json",
    trace_dir="abcdefgh_4gpu_v2-4_trace",
):
    ...
    def expr_abcdefgh(a, b, c, d, e, f, g, h):
        # ((a@b)@(c@d)) @ ((e@f)@(g@h)) — same lowering style as v1-4 (plain @, no lax.dot pin).
        ab = a @ b
...
def main():
    ...
    parser.add_argument("--json", type=str, default="abcdefgh_4gpu_v2-4_stats.json")
    parser.add_argument("--trace-dir", type=str, default="abcdefgh_4gpu_v2-4_trace")
