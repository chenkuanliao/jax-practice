...
def run_benchmark(
    ...
    dtype=jnp.float32,
    warmup_rounds=5,
    output_json="abcd_4gpu_v1-1_stats.json",
    trace_dir="abcd_4gpu_v1-1_trace",
):
...
def main():
    ...
    parser.add_argument("--json", type=str, default="abcd_4gpu_v1-1_stats.json")
    parser.add_argument("--trace-dir", type=str, default="abcd_4gpu_v1-1_trace")
