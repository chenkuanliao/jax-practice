...
def run_benchmark(
    ...
    dtype=jnp.float32,
    warmup_rounds=5,
    output_json="abcdefgh_4gpu_v1-3_stats.json",
    trace_dir="abcdefgh_4gpu_v1-3_trace",
):
    ...
    with mesh:
        ...
        with jax.profiler.StepTraceAnnotation(
            "abcdefgh_profiled_step", step_num=0
        ):
            y = expr_abcdefgh(A, B, C, D, E, F, G, H)
            y.block_until_ready()
        e = time.perf_counter()
    ...
    result = make_base_result(
        ...
        extra={
            "tags": ["abcdefgh", "v1-3", "multi_dot", "flat", "4gpu", "profile"],
            "jax_settings": {
...
def main():
    ...
    parser.add_argument("--json", type=str, default="abcdefgh_4gpu_v1-3_stats.json")
    parser.add_argument("--trace-dir", type=str, default="abcdefgh_4gpu_v1-3_trace")
